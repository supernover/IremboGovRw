...
public class MainActivity extends AppCompatActivity
    ...
    final String url="https://irembo.gov.rw";
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_contact) {
            ...
            sendIntent.putExtra(Intent.EXTRA_TEXT,
                    "Hey ! check out this You can request different Government services online through Irembo app at: https://play.google.com/store/apps/details?id=" + BuildConfig.APPLICATION_ID);
